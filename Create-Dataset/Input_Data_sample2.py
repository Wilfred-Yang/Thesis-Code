...
print(dataset)
dataset.shape = (len(dataset), NTier * NCol) #Reshape the size of generated bay configurations that turns to input data to match the ANN model
#print(dataset)
#dataset.shape = (len(dataset), NTier, NCol)
#dataset = np.transpose(dataset)
#print(dataset)

with open('input_layer_4_6_8_2.pickle', 'wb') as file: #Saving the generated input data as a pickle file
