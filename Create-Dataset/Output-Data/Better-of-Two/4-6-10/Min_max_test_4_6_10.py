# -*- coding: utf-8 -*-
"""
Created on Fri Dec 14 17:20:27 2018
...
with open('input_layer_4_6_10_2.pickle', 'rb') as file:
    input_layer_4_6_10_2 = pickle.load(file)
    
with open('input_layer_4_6_10_3.pickle', 'rb') as file:
    input_layer_4_6_10_3 = pickle.load(file)
    
with open('input_layer_4_6_10_4.pickle', 'rb') as file:
    input_layer_4_6_10_4 = pickle.load(file)


input_layer_trans = np.concatenate((input_layer_4_6_10_2, input_layer_4_6_10_3, input_layer_4_6_10_4), axis = 0)
...
with open('result_min_max_4_6_10.pickle','wb') as file:
