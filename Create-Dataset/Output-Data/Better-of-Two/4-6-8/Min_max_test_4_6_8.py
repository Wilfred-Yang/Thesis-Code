# -*- coding: utf-8 -*-
"""
Created on Tue Dec 11 11:36:59 2018
...
with open('input_layer_4_6_8_2.pickle', 'rb') as file:
    input_layer_4_6_8_2 = pickle.load(file)
    
with open('input_layer_4_6_8_3.pickle', 'rb') as file:
    input_layer_4_6_8_3 = pickle.load(file)
    
with open('input_layer_4_6_8_4.pickle', 'rb') as file:
    input_layer_4_6_8_4 = pickle.load(file)


input_layer_trans = np.concatenate((input_layer_4_6_8_2, input_layer_4_6_8_3, input_layer_4_6_8_4), axis = 0)
...
with open('result_min_max_4_6_8.pickle','wb') as file:
