# -*- coding: utf-8 -*-
"""
Created on Wed Dec 19 21:49:25 2018
...
with open('input_layer_4_6_18_2.pickle', 'rb') as file:
    input_layer_4_6_18_2 = pickle.load(file)
    
with open('input_layer_4_6_18_3.pickle', 'rb') as file:
    input_layer_4_6_18_3 = pickle.load(file)
    
with open('input_layer_4_6_18_4.pickle', 'rb') as file:
    input_layer_4_6_18_4 = pickle.load(file)


input_layer_trans = np.concatenate((input_layer_4_6_18_2, input_layer_4_6_18_3, input_layer_4_6_18_4), axis = 0)
...
with open('result_min_max_4_6_18.pickle','wb') as file:
