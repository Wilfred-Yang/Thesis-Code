# -*- coding: utf-8 -*-
"""
Created on Tue Sep 18 22:26:32 2018
        ...
        for row in range(0, NTier):  
            for column in range(0, NCol):
                if i[row][column] == 1: #find the position of container 1 
                    ...
                    if count == row - 2: ## adjust the row!!!!!!!! if container one is under a container, turn it to row - 1 
...
with open('input_layer_4_6_4_3.pickle', 'wb') as file:
