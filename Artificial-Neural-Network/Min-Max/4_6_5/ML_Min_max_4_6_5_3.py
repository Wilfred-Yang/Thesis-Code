# -*- coding: utf-8 -*-
"""
Created on Sat Jan  5 21:41:17 2019
...
with open('input_layer_4_6_5_3.pickle', 'rb') as file:
    X = pickle.load(file)
    #print(X)
    X = np.transpose(X)
    ...
    X = X[:, 0:2880]
    print(X.shape)
with open('output_layer_4_6_5_3.pickle', 'rb') as file:
    Y = pickle.load(file)
...
with open('weight_Min_max_4_6_5_3.pickle','wb') as file:    
