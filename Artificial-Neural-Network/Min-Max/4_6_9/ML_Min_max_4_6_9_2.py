# -*- coding: utf-8 -*-
"""
Created on Fri Jan 11 09:37:05 2019
...
with open('input_layer_4_6_9_2.pickle', 'rb') as file:
    X = pickle.load(file)
    #print(X)
    X = np.transpose(X)
    ...
    X = X[:, 0:100000]
    print(X.shape)
with open('output_layer_4_6_9_2.pickle', 'rb') as file:
    Y = pickle.load(file)
...
with open('weight_Min_max_4_6_9_2.pickle','wb') as file:    
