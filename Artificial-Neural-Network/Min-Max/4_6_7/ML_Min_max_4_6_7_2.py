# -*- coding: utf-8 -*-
"""
Created on Thu Jan 10 12:14:41 2019
...
with open('input_layer_4_6_7_2.pickle', 'rb') as file:
    X = pickle.load(file)
    #print(X)
    X = np.transpose(X)
    ...
    X = X[:, 0:100000]
    print(X.shape)
with open('output_layer_4_6_7_2.pickle', 'rb') as file:
    Y = pickle.load(file)
...
Parameters = nn_model(X,Y,num_epochs = 300,print_cost = True)
...
with open('weight_Min_max_4_6_7_2.pickle','wb') as file:    
