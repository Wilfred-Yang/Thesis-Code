# -*- coding: utf-8 -*-
"""
Created on Thu Jan 10 15:02:02 2019
...
with open('input_layer_4_6_7_3.pickle', 'rb') as file:
    X = pickle.load(file)
    #print(X)
    X = np.transpose(X)
    ...
    X = X[:, 0:100000]
    print(X.shape)
with open('output_layer_4_6_7_3.pickle', 'rb') as file:
    Y = pickle.load(file)
...
with open('weight_Min_max_4_6_7_3.pickle','wb') as file:    
