# -*- coding: utf-8 -*-
"""
Created on Fri Jan 11 21:46:29 2019
...
with open('input_layer_4_6_18_4.pickle', 'rb') as file:
    ...
    #print(permutation)
    X = X[:, permutation]
    X_valid = X[:, 100000:102000]
    print(X_valid.shape)
    X_test = X[:, 102000:104000]
    X = X[:, 0:100000]
    print(X.shape)
with open('output_layer_4_6_18_4.pickle', 'rb') as file:
    Y = pickle.load(file)
    #permutation = list(np.random.permutation(Y.shape[1]))
    #print(permutation)
    Y = Y[:, permutation]
    Y_valid = Y[:, 100000:102000]
    print(Y_valid.shape)
    Y_test = Y[:, 102000:104000]
    print(Y_test.shape)
    Y = Y[:, 0:100000]
    print(Y.shape)
...
with open('weight_Min_max_4_6_18_4.pickle','wb') as file:    
