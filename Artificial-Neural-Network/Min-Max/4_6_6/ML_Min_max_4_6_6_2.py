# -*- coding: utf-8 -*-
"""
Created on Tue Jan  8 20:22:55 2019
...
with open('input_layer_4_6_6_2.pickle', 'rb') as file:
    X = pickle.load(file)
    #print(X)
    X = np.transpose(X)
    ...
    X = X[:, 0:86400]
    print(X.shape)
with open('output_layer_4_6_6_2.pickle', 'rb') as file:
    Y = pickle.load(file)
...
Parameters = nn_model(X,Y,num_epochs = 390,print_cost = True)
...
with open('weight_Min_max_4_6_6_2.pickle','wb') as file:    
