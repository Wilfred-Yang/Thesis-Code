# -*- coding: utf-8 -*-
"""
Created on Wed Jan  9 22:42:13 2019
...
with open('input_layer_4_6_6_4.pickle', 'rb') as file:
    X = pickle.load(file)
    #print(X)
    X = np.transpose(X)
    ...
    X = X[:, 0:10800]
    print(X.shape)
with open('output_layer_4_6_6_4.pickle', 'rb') as file:
    Y = pickle.load(file)
...
Parameters = nn_model(X,Y,num_epochs = 500,print_cost = True)
...
with open('weight_Min_max_4_6_6_4.pickle','wb') as file:    
