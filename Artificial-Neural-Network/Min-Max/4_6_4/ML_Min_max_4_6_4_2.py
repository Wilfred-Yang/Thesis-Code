# -*- coding: utf-8 -*-
"""
Created on Sat Jan  5 16:21:23 2019
...
with open('input_layer_4_6_4_2.pickle', 'rb') as file:
    X = pickle.load(file)
    #print(X)
    X = np.transpose(X)
    ...
    X = X[:, 0:756]
    print(X.shape)
with open('output_layer_4_6_4_2.pickle', 'rb') as file:
    Y = pickle.load(file)
...
with open('weight_Min_max_4_6_4_2.pickle','wb') as file:    
