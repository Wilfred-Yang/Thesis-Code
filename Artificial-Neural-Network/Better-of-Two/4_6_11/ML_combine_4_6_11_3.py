# -*- coding: utf-8 -*-
"""
Created on Thu Jan 17 21:40:15 2019
...
with open('input_layer_4_6_11_3.pickle', 'rb') as file:
    ...
    X = X[:, 0:100000]
    print(X.shape)
with open('output_layer_4_6_11_3.pickle', 'rb') as file:
    Y = pickle.load(file)
    Y = np.transpose(Y)
    #print(Y.shape)
...
Parameters = nn_model(X,Y,num_epochs = 90,print_cost = True)
...
with open('weight_combine_4_6_11_3.pickle','wb') as file:    
