# -*- coding: utf-8 -*-
"""
Created on Thu Jan 17 05:03:54 2019
...
with open('input_layer_4_6_8_2.pickle', 'rb') as file:
    ...
    #print(permutation)
    X = X[:, permutation]
    X_valid = X[:, 200000:201000]
    print(X_valid.shape)
    X_test = X[:, 201000:202000]
    X = X[:, 0:200000]
    print(X.shape)
with open('output_layer_4_6_8_2.pickle', 'rb') as file:
    Y = pickle.load(file)
    Y = np.transpose(Y)
    print(Y.shape)
    ...
    #print(permutation)
    Y = Y[:, permutation]
    Y_valid = Y[:, 200000:201000]
    print(Y_valid.shape)
    Y_test = Y[:, 201000:202000]
    print(Y_test.shape)
    Y = Y[:, 0:200000]
    print(Y.shape)
...
with open('weight_combine_4_6_8_2.pickle','wb') as file:    
