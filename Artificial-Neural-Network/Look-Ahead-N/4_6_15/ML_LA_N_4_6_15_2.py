# -*- coding: utf-8 -*-
"""
Created on Wed Jan 16 20:31:56 2019
...
with open('input_layer_4_6_15_2.pickle', 'rb') as file:
    ...
    X = X[:, 0:100000]
    print(X.shape)
with open('output_layer_4_6_15_2.pickle', 'rb') as file:
    Y = pickle.load(file)
...
def nn_model(X,Y,num_epochs = 500000, optim_algorithm = "Adam", beta_1 = 0.9, beta_2 = 0.999, epsilson = 1e-8, learning_rate = 0.007, print_cost = False):
...
Parameters = nn_model(X,Y,num_epochs = 200,print_cost = True)
...
with open('weight_LA_N_4_6_15_2.pickle','wb') as file:    
