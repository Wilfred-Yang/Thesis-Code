# -*- coding: utf-8 -*-
"""
Created on Wed Jan 16 23:21:58 2019
...
with open('input_layer_4_6_15_3.pickle', 'rb') as file:
    ...
    X = X[:, 0:100000]
    print(X.shape)
with open('output_layer_4_6_15_3.pickle', 'rb') as file:
    Y = pickle.load(file)
...
Parameters = nn_model(X,Y,num_epochs = 150,print_cost = True)
...
with open('weight_LA_N_4_6_15_3.pickle','wb') as file:    
